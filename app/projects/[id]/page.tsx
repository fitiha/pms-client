...
import { getProjectById, updateProject, deleteProject, getCurrentUser, getTasksByProjectId } from '@/lib/auth'
      ...
      {isEditing ? (
        <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
          ...
          <div>
            ...
            <Input id="startDate" name="startDate" type="date" defaultValue={project.startDate.split('T')[0]} required />
          </div>
          <div>
            <Label htmlFor="endDate">End Date</Label>
            <Input id="endDate" name="endDate" type="date" defaultValue={project.endDate ? project.endDate.split('T')[0] : ''} />
          </div>
        ...
        <div className="space-y-4">
          ...
          {currentUser && (currentUser.id === project.ownerId || currentUser.role === 'ADMIN') && (
