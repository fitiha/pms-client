...
import { getTaskById, updateTask, deleteTask, getCurrentUser, assignTask, getCommentsByTaskId, Task, User, Comment } from '@/lib/auth'
    ...
    <div className="container mx-auto py-10">
      ...
      {isEditing ? (
        ...
        <div className="space-y-4">
          ...
          <p><strong>Assigned To:</strong> {task.assigneeId ? `User ${task.assigneeId}` : 'Unassigned'}</p>
          {currentUser && (currentUser.id === task.assigneeId || currentUser.role === 'ADMIN' || currentUser.role === 'PROJECT_MANAGER') && (
      ...
      <div className="mt-8">
        ...
        <CommentSection taskId={task.id} comments={comments} setComments={setComments} />
      </div>
    </div>
  )
}
